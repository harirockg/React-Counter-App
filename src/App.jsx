...
function App() {
  ...
  return (
    <div className="w-[100vw] h-[100vh] flex flex-col justify-center items-center bg-[#344151] gap-10">
      ...
      <div className="text-[#0398d4] font-medium text-2xl">Increment and Decrement Counter</div>
      ...
      <button onClick={resetHandler} className="bg-[#0398d4] text-white px-6 py-2 rounded-sm text-lg">
        Reset
      </button>
